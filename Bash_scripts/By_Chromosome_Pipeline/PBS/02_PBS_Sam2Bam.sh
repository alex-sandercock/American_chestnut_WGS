...
#### Usage to submit 1 job per sample file: find `pwd` -maxdepth 1 -iname '*.sam' -exec qsub 02_PBS_Sam2Bam.sh -v SAMFILE='{}' \;
###############################################################################
...
###print PBS script
PBS_script="/work/newriver/amsand/GenomeAnalysis/FASTQs/02_PBS_Sam2Bam.sh"
echo '#############################################################################'
more $PBS_script
echo '#############################################################################'
###########################################################################
